const db = {
  data: {
    ...
    qualifications: [
      ...
      {
        id: 'q3',
        name: 'Airbus A320 Certification',
        description: 'Certified to fly A320',
        candidateIds: [],
        roleIds: ['r3'],
        createdAt: '2011-10-05T14:48:00.000Z',
        updatedAt: null,
      ...
      {
        id: 'q4',
        name: 'Airbus A330 Certification',
        description: 'Certified to fly A330',
        candidateIds: [],
        roleIds: ['r4'],
        createdAt: '2011-10-05T14:48:00.000Z',
        updatedAt: null,
...
export const createCandidate = (name, description) => {
...
export const updateCandidate = (id, name, description) => {
...
export const updateQualification = (id, name, description) => {
